...
save_directory     <- "outputs/stocks-flows/entry-input-df/v3/"
...
write_csv(econ_forecast, file = paste0(proj_dir, save_directory, "field_capex_opex_forecast_revised", s_suff, ".csv"))
