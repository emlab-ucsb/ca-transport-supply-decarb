# extraction production and ghg emissions under innovation scenarios
...
# ------------------------- plots ------------------------- 
  ...
  # plot: extraction under price paths -------- 
    ...
    fig_innovation_bbl = ggplot(dt_res, aes(x = year, y = prod_mbbl, color = innovation_scenario)) +
      geom_line() +
      labs(title = 'Production under innovation scenarios',
    ...
    ggsave(fig_innovation_bbl,
           filename = file.path(fig_path, 'extraction_innovation_scenarios_production.png'),
           width = 6.5,
           height = 4.5,
           dpi = 400, 
           units = 'in', 
    ...
    ggsave(fig_innovation_bbl,
           filename = file.path(fig_path, 'extraction_innovation_scenarios_production.pdf'),
           width = 6.5,
           height = 4.5,
           units = 'in', 
           device = 'pdf')
    
    embed_fonts(file.path(fig_path, 'extraction_innovation_scenarios_production.pdf'),
                outfile = file.path(fig_path, 'extraction_innovation_scenarios_production.pdf'))
    
    
  # plot: ghg emissions under price paths -------- 
    
    fig_innovation_ghg = ggplot(dt_res, aes(x = year, y = ghg_mmt_inno_ccs_adj, color = innovation_scenario)) +
      geom_line() +
      labs(title = NULL,
           subtitle = NULL, 
           x = NULL,
    ...
    ggsave(fig_innovation_ghg,
           filename = file.path(fig_path, 'extraction_innovation_scenarios_ghg.png'),
           width = 6.5,
           height = 4.5,
           dpi = 400, 
           units = 'in', 
    ...
    ggsave(fig_innovation_ghg,
           filename = file.path(fig_path, 'extraction_innovation_scenarios_ghg.pdf'),
           width = 6.5,
           height = 4.5,
           units = 'in', 
           device = 'pdf')
    
    embed_fonts(file.path(fig_path, 'extraction_innovation_scenarios_ghg.pdf'),
                outfile = file.path(fig_path, 'extraction_innovation_scenarios_ghg.pdf'))
