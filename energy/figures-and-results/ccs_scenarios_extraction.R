# extraction production and ghg emissions under ccs scenarios
...
# ------------------------- plots ------------------------- 
  ...
  # plot: extraction under price paths -------- 
    ...
    fig_ccs_price_bbl = ggplot(dt_res, aes(x = year, y = prod_mbbl, color = ccs_scenario)) +
      geom_line() + 
      facet_grid(cols = vars(carbon_price_scenario)) + 
      labs(title = 'Production under CCS scenarios',
    ...
    ggsave(fig_ccs_price_bbl,
           filename = file.path(fig_path, 'extraction_ccs_price_paths_production.png'),
           width = 6.5,
           height = 4,
           dpi = 400, 
           units = 'in', 
    ...
    ggsave(fig_ccs_price_bbl,
           filename = file.path(fig_path, 'extraction_ccs_price_paths_production.pdf'),
           width = 6.5,
           height = 4,
           units = 'in', 
           device = 'pdf')
    
    embed_fonts(file.path(fig_path, 'extraction_ccs_price_paths_production.pdf'),
                outfile = file.path(fig_path, 'extraction_ccs_price_paths_production.pdf'))
    
    
  # plot: ghg emissions under price paths -------- 
    
    fig_ccs_price_ghg = ggplot(dt_res, aes(x = year, y = ghg_mmt_inno_ccs_adj, color = ccs_scenario)) +
      geom_line(alpha = 0.9) +
    ...
    ggsave(fig_ccs_price_ghg,
           filename = file.path(fig_path, 'extraction_ccs_price_paths_ghg.png'),
           width = 6.5,
           height = 4,
           dpi = 400, 
           units = 'in', 
    ...
    ggsave(fig_ccs_price_ghg,
           filename = file.path(fig_path, 'extraction_ccs_price_paths_ghg.pdf'),
           width = 6.5,
           height = 4,
           units = 'in', 
           device = 'pdf')
    
    embed_fonts(file.path(fig_path, 'extraction_ccs_price_paths_ghg.pdf'),
                outfile = file.path(fig_path, 'extraction_ccs_price_paths_ghg.pdf'))
