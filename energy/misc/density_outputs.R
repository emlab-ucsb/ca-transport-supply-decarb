...
density_out = fread(file.path(base_path, 'extraction_2021-07-01', 'revised-annual-ghg-factors', 'diagnostic-density-results.csv'), header = T, colClasses = c('doc_field_code' = 'character'))

field_out = fread(file.path(base_path, 'extraction_2021-07-01', 'revised-annual-ghg-factors', 'diagnostic-field-level-results.csv'), header = T, colClasses = c('doc_field_code' = 'character'))
