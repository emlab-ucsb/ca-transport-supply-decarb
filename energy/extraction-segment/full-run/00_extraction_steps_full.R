# inputs -----
  ...
  scen_selection   = 'carbon_setback_scens' ## diagnostic, benchmark, tax_scens, full_run, full_run_subset, carbon_scens, carbon_setback_scens
  run_type = "carbon_setback_search"
