## Tracey Mangin
## May 10, 2021
## test version: Create v1 entry model input df
...
find_n_asset <- function(fcode) {
  ...
  nf <- st_nn(field_sp, asset_loc_sf, k = 1, returnDist = T)
...
write.csv(nn_assets, paste0(rystad_path, "fieldsAssets_adj_test.csv"))
...
## save file
write_csv(all_combos, file = paste0(save_directory, "stocks-flows/entry-model-input/field_asset_matches_v1_TEST.csv"))
