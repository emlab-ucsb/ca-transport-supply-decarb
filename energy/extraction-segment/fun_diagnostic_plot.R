plot_diagnostic_outputs <- function(oil_price_selection, output_extraction) {
  ...
  state_base = fread(file.path(base_path, 'extraction_2021-08-02', 'update-exiting-prod-estimate', 'diagnostic-state-level-results.csv'), header = T)
  ...
  state_base[, version := "updated-remove-plugged"]
